        ...
        >
            ...
            <div className="mx-auto max-w-7xl">
                <div ref={sheetRef} className="print-sheet rounded-lg bg-white p-4 shadow-sm sm:p-8">
                    {/* Printed page 1: letterhead, leaderboard and the panel's signatures. */}
                    <div data-print-page>
                        ...
                        {/* On paper the signatures close page 1; on screen they stay at the bottom of the sheet. */}
                        <div className="hidden print:block">
                            <EvaluatorSignatures evaluators={evaluators} />
                        </div>
                    </div>

                    {/* Printed page 2: every track's ranking. */}
                    <div data-print-page>
                        <h3 className="mb-2 hidden text-sm font-bold uppercase tracking-wide text-emerald-900 print:block">
                            Results by track
                        </h3>
                        {/* Per-track rankings */}
                        <section className="grid gap-4 md:grid-cols-2 print:grid-cols-4 print:gap-3">
